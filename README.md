# Serverless Cars Rent

This project implement a simple Car Rent application using AWS Lambda and Serverless framework.
...
* `status` (boolean) - true if an item was completed, false otherwise
...
This should start a development server with the React application that will interact with the serverless Car Rental application.
